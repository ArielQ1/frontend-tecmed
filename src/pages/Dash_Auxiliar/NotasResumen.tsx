...
export function AuxiResumenNotas({ materia, parcialesDocente, notasResumen, inscritos, onVolver }: Props) {
  ...
  const todasLasCols: ParcialCol[] = [...colsParciales]; // auxiliar: solo prácticas, sin columna extra
    ...
    <div className="dd-tab rn-root" style={{ maxWidth: 1100 }}>
      ...
      <header className="dd-tab-header" style={{ display: "flex", alignItems: "flex-start", gap: 16 }}>
        <div style={{ flex: 1 }}>
          ...
          <h1 className="dd-tab-title">Prácticas — {materia.sigla}</h1>
